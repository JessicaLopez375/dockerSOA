...
module.exports = {
    ...
    adminAuth: {
        ...
        users: [{
            username: "admin",
            password: "$2a$08$5yi8tpKeGKrMD9QECfRivO.fMRxAbThHABTCmVZ/KEcqVxHuOaWZ.",
            permissions: "*"
        }]
    },
    ...
    //// https object:
    https: {
      key: require("fs").readFileSync('/data/cert/privkey.pem'),
      cert: require("fs").readFileSync('/data/cert/cert.pem')
    },
    ////https function:
    // https: function() {
